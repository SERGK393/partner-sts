...
?><style>
	...
	.moneyback{
		background-image:url('/images/warranty/moneyBack.png');
	}
</style>
<div class="wrnty-wrp wrnty">
	<h4>Гарантия и контроль качества:</h4>
	<p>
		 На все товары, приобретенные в нашем интернет-магазине, распространяется гарантия производителя согласно срокам и условиям гарантийного обслуживания, которые указаны в паспорте изделия. В течение гарантийного срока, покупатель вправе предъявить любые требования предусмотренные законом.
	</p>
</div>
<div class="wrnty-wrp moneyback">
	<h4>Обмен и возврат товара:</h4>
	<p>
		 Покупатель вправе обменять или отказаться от товара надлежащего качества, не подошедшего по каким-либо причинам (как до передачи товара так и после -в течение 7&nbsp;дней). Возврат товара надлежащего качества возможен, если сохранены товарный вид и потребительские свойства. В случае возврата товара надлежащего качества, произошедшего после передачи, покупателю возвращается сумма уплаченная за товар, за исключением расходов на доставку.
	</p>
</div>
<div class="bx_page">
	<p>
 ...
 <b>Внимание!</b> Для каждого отдельного заказа возможен только один способ оплаты на ваш выбор. Оплата заказа по частям различными способами невозможна.
	...
	<ul>
		...
		<li><b>Оплата банковской картой онлайн (Visa / Mastercard)</b>.&nbsp; <br>
 <br>
 </li>
	</ul>
</div>

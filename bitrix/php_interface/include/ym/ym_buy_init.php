...
$requestObject = isset($json["REQUEST_OBJECT"]) ? $json["REQUEST_OBJECT"] : '';
...
$siteId = isset($matches[2]) ? $matches[2] : 's1';
...
$YMHandler = new CSaleYMHandler1(array(
	"SITE_ID" => $siteId
));

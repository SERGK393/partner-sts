...
<div class="top-panel">
	...
	false
);?></div><div id="top-panel-del-points-cnt">
	...
	false
        ...
        <div class="top-panel-sign-reg"><b><?$APPLICATION->IncludeComponent(
...
<div class="wrapper">
    ...
    <div class="clear-both"></div>
<?
 /*if ($_SESSION['TF_LOCATION_SELECTED_CITY_NAME']=='Воронеж' && !isPartnerClient()): ?>
 	<img src="/bitrix/images/deliv-vrn.png">
 <?endif*/?>

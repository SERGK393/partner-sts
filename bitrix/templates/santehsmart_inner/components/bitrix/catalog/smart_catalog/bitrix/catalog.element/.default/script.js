...
window.JCCatalogElement.prototype.initConfig = function()
{
	...
	if (!!this.params.CONFIG && typeof(this.params.CONFIG) === 'object')
	{
		...
		this.config.partnerID = this.params.CONFIG.PARTNER_ID;
	...
	else
	{
		...
		this.config.partnerID = this.params.PARTNER_ID;
...
window.JCCatalogElement.prototype.calcMagnifierParams = function()
{
	if (!!this.magnify.obBigImg)
	{
		...
		this.magnify.magnifierParams.width = 700;
		this.magnify.magnifierParams.height = pos.height;
		this.magnify.magnifierParams.top = pos.top;
		this.magnify.magnifierParams.left = pos.left + pos.width + 2 + 50;
	}
};
...
window.JCCatalogElement.prototype.calcMagnifyAreaSize = function()
{
		...
		)
	{
		...
		//scaleX = 700/this.currentImg.width;
	...
	else
	{
		...
		scaleX = this.obPict.offsetWidth/700;
	...
	if (0 === this.errorCode && this.config.showQuantity && this.canBuy)
	{
		...
		if (!isNaN(curValue))
		{
			...
			if (boolSet)
			{
                ...
                this.obQuantity.setAttribute('value',curValue);
			}
		}
	}
};
	...
	if (0 === this.errorCode && this.config.showQuantity)
	{
		if (this.canBuy)
		{
			...
			else
			{
                ...
                this.obQuantity.setAttribute('value',this.stepQuantity);
			}
		}
		else
		{
...
window.JCCatalogElement.prototype.SendToBasket = function()
{
	...
	if(partnerButton.hasClass('active') || !this.config.partnerID){
...
window.JCCatalogElement.prototype.Basket = function()
{
	...
	if (!this.canBuy)
	{
	    ...
	    var partnerID = this.config.partnerID;

...
<div id="basket_items_list">
	<div id="jsjs1" class="bx_ordercart_order_table_container">
		<table id="basket_items">
			...
			<tbody>
				...
				?>
					<tr id="<?=$arItem["ID"]?>" data-sku="<?=$arItem["PRODUCT_XML_ID"]?>">
						<td class="margin"></td>
						<?
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
	...
	<div id="jsjs" class="bx_ordercart_order_pay">

		<div class="bx_ordercart_order_pay_left" id="coupons_block">
			<div class="bx_ordercart_coupon">
				<span<?=(isPartnerClient()?' style="display:none"':'')?>><?=GetMessage("STB_COUPON_PROMT")?></span><input type="text" id="coupon" name="COUPON" value="" onchange="enterCoupon();"<?=(isPartnerClient()?' style="display:none"':'')?>>
			</div><?
...
?>
		...
		<div class="bx_ordercart_order_pay_center">
			<span><a id="js_return_to_sale" href="/">Вернуться к покупкам</a></span>

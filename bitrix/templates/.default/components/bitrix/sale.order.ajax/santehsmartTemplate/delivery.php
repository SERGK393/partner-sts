...
5
							...
							<div id="delivery_dop_prop">

<?
echo $delivery_id;
if($delivery_id==59):
    if($arProfile["CHECKED"]=='Y'){?>
<div id='curier'><label>Адрес для доставки курьером:<br><textarea  name="ORDER_PROP_7" length="15"></textarea></label><br>
</div>
<?}endif;?>
<?if($profile_id==58) $APPLICATION->IncludeComponent(
				...
				?>
					<div class="bx_block vertical">
						...
						<div class="bx_element">
							...
							<?
							if($delivery_id==59):?>
								<div id='curier'><label>Адрес для доставки курьером:<br><textarea  name="<?=$arDelivery["CHECKED"]=='Y'?'ORDER_PROP_7':''?>" length="15" <?=$arDelivery["CHECKED"]=='Y'?'':'readonly'?>></textarea></label><br>
								</div>
							<?endif;?>

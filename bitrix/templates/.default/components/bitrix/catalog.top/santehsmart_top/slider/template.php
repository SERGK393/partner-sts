...
<div id="<? echo $strContID; ?>" class="bx_catalog_tile_home_type_2">
<span class="title"><?= $arParams['Z_TITLE'] ?></span>
<div class="bx_catalog_tile_section"<?if(isset($arParams['Z_INDEX'])){?> style="z-index: <?=$arParams['Z_INDEX']?>"<?}?>>
<?
$boolFirst = true;
$arRowIDs = array();
foreach ($arResult['ITEMS'] as $keyRow => $arOneRow)
{
	...
	$arRowIDs[] = $strRowID;
?>
<div id="<? echo $strRowID; ?>" class="bx_catalog_tile_slide <? echo ($boolFirst ? 'active' : 'notactive'); ?>"<?if(isset($arParams['Z_INDEX'])){?> style="z-index: <?=$arParams['Z_INDEX']?>"<?}?>>
<?
